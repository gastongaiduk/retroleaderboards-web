...
Cypress.Commands.add('interceptRACredentials', (existing = true, username = "demo", apiKey = "demo-key") => {
    if (existing) {
...
declare global {
  namespace Cypress {
    interface Chainable {
      ...
      interceptRACredentials(existing: boolean, username: string, apiKey: string): Chainable<void>
